...
**What is skipped:** names starting with `_`, `@no_stage`-marked methods, `@staticmethod`, `@classmethod`, `@property`, and inherited methods (apply `@narrative_class` to the base class separately).
